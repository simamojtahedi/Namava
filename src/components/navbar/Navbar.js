...
const Navbar = () => {
    let windowPageOffsetRef = useRef(window.pageYOffset)
    ...
    useEffect(() => {
        const onScrollHandler = () => {
            ...
            } else if (currentPageOffset < windowPageOffsetRef.current) {
                navbarRef.current.classList.remove('floating')
            ...
            windowPageOffsetRef.current = currentPageOffset;
        }
